...
var _docClick = null;
function GetCalendar(imgClick,name){	
	//, year, month, day
//	alert("tjw");
//	alert("name="+name+"\nyear="+year+"\nmonth="+month+"\nday="+day);
//	alert("_bHaveUpdated="+_bHaveUpdated);
//	alert("imgClick == imgCurrent="+imgClick == imgCurrent);
 	if(_bHaveUpdated && imgClick == imgCurrent) return;
 	
 	_docClick = document.onclick;
 	document.onclick = hideCldTabFrm;
 	
	objYear	=document.getElementById(name + "_year").value;
	objMonth=document.getElementById(name + "_month").value;
	objDay	=document.getElementById(name + "_day").value;
...
//	alert("objYear="+objYear);
//	alert("objMonth="+objMonth);
//	alert("objDay="+objDay);
