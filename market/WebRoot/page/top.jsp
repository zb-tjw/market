					...
					<TBODY>
						<TR>
							...
							<TD class=blank vAlign=bottom align=right>
								<A class=blank href="http://www.jnxy.edu.cn/" target="">济院首页</A> |
							</TD>
						</TR>
					</TBODY>
				</TABLE>
    ...
    <TD height=31>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          ...
          <TD width="7%">&nbsp;</TD>
          <TD width="18%"><IMG onClick=ShowMenu(list,90)
            height=31 src="${ctx}/images/page/top2_2_2.jpg" width=91 border=0></TD><!-- onmouseover -->
          <TD width="9%">&nbsp;</TD>
