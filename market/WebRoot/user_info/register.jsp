                    ...
                    <TR>
                      <TD>
                        ...
                        width=600>
                          ...
                          <TR>
                            <TD class=f14 width=161 height=32><FONT 
                              face=宋体>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<SPAN 
                            ...
                            name="username" ></SPAN></TD>
                            <!-- onblur="checkUsernameFormat(this)" -->
                            <TD align=left>
                          ...
                          <TR>
                            <TD class=f14 align=right width=111 
                              height=31><FONT face=宋体><FONT 
                              color=#ff0000>*</FONT>生日：</FONT></TD>
                            <TD width=319 colSpan=2 height=31>
                            <FONT face=宋体>
                            <SPAN class=DPFrame style="FONT-SIZE: 15pt; padding-top:6px"><!-- id=jobTimeDateTimePicker -->
				            <INPUT class=DPYear onkeypress="return KeyFilter('number');" 
				                   id=birthday_year onkeydown="return dp_keyDown('year');" 
				                    onfocus="return dp_focus('year');" 
